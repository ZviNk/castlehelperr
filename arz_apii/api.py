...
from arz_apii.consts import MAIN_URL
from arz_apii.bypass_antibot import bypass

from arz_apii.exceptions import IncorrectLoginData, ThisIsYouError
from arz_apii.models.other import Statistic
from arz_apii.models.post_object import Post, ProfilePost
from arz_apii.models.member_object import Member, CurrentMember
from arz_apii.models.thread_object import Thread
from arz_apii.models.category_object import Category
...
class ArizonaAPI:
    ...
    def edit_thread_info(self, thread_id: int, title: str = None, prefix_id: int = None) -> Response:
        ...
        if prefix_id is not None:
            data.update({'prefix_id': str(prefix_id)})
